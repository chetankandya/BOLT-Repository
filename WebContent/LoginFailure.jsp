			...
			<div class="container">
				<div class="banner-inner">
					<div class="col-md-5 banner-left">
						...
						<h4>Invalid Credentials. Please enter again.</h4>
						
					<div class="submit">
								<a href = "login.jsp"><input type="submit" value="Retry Login"></a>
									<a href = "forgotpassword.jsp"><input type="reset" value="Forgot Password"></a>
								</div>		
						<br>
