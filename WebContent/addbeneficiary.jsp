...
<!-- Head -->
<head>
<title>BOLT | ADD_BENEFICIARY</title>
		...
		<div class="container">
			<div class="banner-inner">
				<div class="col-md-5 banner-left">
					<form action="addBeneficiary.do" method="post">
						<div width="40%">
							<h3>ADD NEW BENEFICIARY</h3>
							<input type="text" name="benAccNo" placeholder="Account Number"
								maxlength="9" required="" /> <input type="text" name="benName"
								placeholder="Account Holder Name" required="" /> <input
								type="text" name="benPhone" placeholder="Mobile Number"
								minlength="10" maxlength="10" required="" /> <input type="text"
								name="benBank" placeholder="Bank Name" required="" /> <input
								type="text" name="benIfsc" placeholder="IFSC Code"
								minlength="10" maxlength="12" required="" /> <input type="text"
								name="benDesc" placeholder="Additional Message">
						</div>
