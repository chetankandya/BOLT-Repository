...
<!-- Head -->
<head>
<title>BOLT | FUND_TRANSFER</title>
					...
					<div class="col-sm-6">
						...
						<div width="40%">
								...
								<select>
									...
									<option   name="benAccNo"></option>
								</select>
								<input type="text" name="benName" placeholder="Account Holder Name" disabled>
								<input type="text" name="amountWithdarwn" placeholder="Amount">
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div width="40%">
								<h2>To Account</h2>
								<input type="text" name="benAccNo" placeholder="Account Number" maxlength="10" required=""/>
								<input type="text" name="benName" placeholder="Account Holder Name" required=""/>
								<input type="text" name="amountDeposit" placeholder="Amount">
