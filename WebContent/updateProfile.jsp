		...
		<div class="container">
			<div class="banner-inner">
				<div class="col-md-5 banner-left">
					...
					<div class="submit">
					<a href="get.do"><input type="submit" value="Get Details"> </a>
					</div>
						<form action="update.do" method="post">
						<!--  <input type="text" name="custId" placeholder="Username" autofocus required=""/> -->
						<input type="text" name="custName" placeholder="Customer Name"
							value="${details.custName}" required="" /> <input type="text"
							name="mobileNo" id="phonenumber" placeholder="Mobile Number"
							maxlength="10" value="${details.mobileNo}" required="" />
						...
						<input type="email" name="emailId" placeholder="Email"
							value="${details.emailId}" required="" />
						<!-- <input type="password"  name="password" minlength="8" placeholder="Password" minlength="6" required=""/> -->
						<input type="date" name="dateOfBirth" placeholder="DOB"
							value="${details.dateOfBirth}" required="" /> <input type="text"
							name="address" placeholder="Address" value="${details.address}"
							required="" /> <input type="text" name="city" placeholder="City"
							value="${details.city}" required="" /> <input type="text"
							name="country" placeholder="Country" value="${details.country}"
							required="" /> <input type="text" name="pincode" minlength="6"
							maxlength="6" placeholder="PinCode" value="${details.pincode}"
							required="" />
						<!-- 	<input type="number"  name="aadharNo" placeholder="Aadhar Card" minlength="12" maxlength="12" required=""/>
							<input type="text" name="panNo"  minlength="10" maxlength="10" placeholder="Pan Card" maxlength="8" required=""/> -->
		...
		<div class="container">
			<div class="footer-grids">
				<div class="col-md-4 footer-grid1">
					...
					<p>Bank Of Larsen and Toubro welcomes you to explore the world
						of premier bank in India.</p>
				...
				<div class="col-md-2 footer-grid3">
					...
					<p>
						<a href="#payment" class="scroll">payment</a>
					</p>
					<p>
