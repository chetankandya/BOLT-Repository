...
<body>
	...
	<div align="right"><h3 color="blue">Welcome <%=cust.getCustName()%></h3>
	<br><a href="logout.jsp"><button onclick="alert('Logout Successfully.\nThank You For Your Trust...')">Logout</button></a>
	</div>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="myNavbar">
					<ul class="nav navbar-nav navbar-right">
						<li onclick="color:"red";"><a href="userhome.jsp">My
								Account</a></li>
				...
				<div class="col-md-5 banner-left">
					...
					<div width="50%">
						<h3>Account Balance</h3>
						   ...
						   <%   
									entity.AccountDetails ad = ( entity.AccountDetails) session.getAttribute("ad");
									
							%>

						<input type="text" name="savingBalance"
							value='&#8377 <%=ad.getBalance()%> /-' disabled />

					</div>
					<h3>Quick Links</h3>
					<div class="submit">
						<a href="debit.jsp"><input type="submit" value="Fund Transfer"></a>
						<a href="accountstatement.jsp"><input type="submit"
