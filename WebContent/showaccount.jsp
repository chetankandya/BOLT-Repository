		...
		<div class="container">
			<div class="banner-inner">
				<div class="col-md-5 banner-left">
					...
					<h3>${details.custName}Details</h3>

					<form action="show.do">
						<input type="submit" value="View Details">
					</form>

					AccNo <input type="text" value="${account.accNo}" disabled>
					Branch <input type="text" value="${account.branch}" disabled>
					Balance <input type="text" value="${account.balance}" disabled>
					Acctype <input type="text" value="${account.acctype}" disabled>
					Date Of Opening <input type="text" value="${account.dateOfOpening}"
						disabled>
