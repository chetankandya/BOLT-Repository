			...
			<div class="container">
				<div class="banner-inner">
					<div class="col-md-5 banner-left">
						...
						<%-- <jsp:useBean id="customer" class="entity.CustomerDetails" scope="session"></jsp:useBean>
						<h2><jsp:getProperty property="custId" name="customer"/></h2> --%>
							
							<input type="text" name="branch"  placeholder="Branch" />
							<input type="text" name="balance" placeholder="Deposit Amount"/>
							<!-- <input type="text" name="accounttype" value="Savings Account" /> -->							
							<select name="accounttype">
                                   <option value="Savings Account">Savings Account</option>
                            </select>
							<input type="date" name="date"  min="1947-08-15"  max="2018-07-20" placeholder="Account Opening Date"/>
