				...
				<!-- Brand and toggle get grouped for better mobile display -->
					...
					<div class="collapse navbar-collapse" id="myNavbar">
						<ul class="nav navbar-nav navbar-right">
							...
							<!-- <li><a href="debit.jsp">Click To Debit</a></li>
			...
			<div class="container">
				<div class="banner-inner">
					<div class="col-md-5 banner-left">
						...
						<form name="myForm" action="addAdmin.do" onsubmit="return validateForm();" method="post">
						<h3>Add New Admin</h3>
						    <input type="text" name="adminId" placeholder="Admin Id" autofocus required=""/>
							...
							<div class="submit">
									<input type="submit" value="Add Admin" onclick="alert('Admin Successfully Added')">
