...
function showCustomer(str) {
  ...
  xhttp.open("GET", "accountNumberexists.jsp?q="+str, true);
  xhttp.send();
}
</script>
		...
		<div class="container">
			<div class="banner-inner">
				<div class="col-md-5 banner-left">
					...
					<form action="debit.do" method="post">
						<h3>Fund Transfer</h3>
						
						   <div id="txtHint">Debit Info </div>
						    <label>Enter Account Number</label>
						   <input type="text" name="benAccNo" placeholder="Account Number" maxlength="9" required=""  oninput="showCustomer(this.value)"/> 
