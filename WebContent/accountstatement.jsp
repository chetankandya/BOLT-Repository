...
<!-- Head -->
<head>
<title>BOLT | ACCOUNT_STATEMENT</title>
			...
			<div class="banner-inner">
				<div class="col-md-5 banner-left">
					...
					<form action="transaction.do" method="post">
						...
						From Date: <input type="date" name="from_date"> To Date:
						<input type="date" name="to_date">
					

						<div class="submit">
							<input type="submit" value="SHOW TRANSACTION"> <input
					...
					<br>
					<h4>
						<a href="lasttransamount.do">View Last Transaction</a>
					</h4>
					<br>
					<h4>
						<a href="lastsix.do">View Transaction For Last 6 Months</a>
					</h4>
